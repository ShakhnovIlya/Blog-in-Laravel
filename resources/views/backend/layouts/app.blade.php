...
<head>
  ...
  <link href="{{ url('public/assets/front/vendor/boxicons/css/boxicons.min.css') }}" rel="stylesheet">
  <link href="{{ url('public/assets/front/vendor/quill/quill.snow.css') }}" rel="stylesheet">
  <link href="{{ url('public/assets/front/vendor/quill/quill.bubble.css') }}" rel="stylesheet">
  <link href="{{ url('public/assets/front/vendor/remixicon/remixicon.css') }}" rel="stylesheet">
  <link href="{{ url('public/assets/front/vendor/simple-datatables/style.css') }}" rel="stylesheet">
